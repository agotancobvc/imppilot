...
export async function refreshToken(req, res) {
    ...
    try {
        ...
        const newAccess = jwt.sign({ sub: decoded.sub, pid: decoded.pid, cid: decoded.cid }, process.env.JWT_ACCESS_SECRET, { issuer: env.JWT_ISSUER, expiresIn: env.JWT_ACCESS_EXPIRES });
