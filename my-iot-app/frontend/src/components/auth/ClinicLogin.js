...
var ClinicLogin = function () {
    var _a = (0, react_1.useState)(''), clinicCode = _a[0], setClinicCode = _a[1];
    var _b = (0, react_1.useState)(false), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(''), error = _c[0], setError = _c[1];
    var setClinic = (0, authStore_1.useAuthStore)().setClinic;
    var navigate = (0, react_router_dom_1.useNavigate)();
    var handleSubmit = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var response, clinic, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("".concat(process.env.REACT_APP_API_URL, "/auth/clinic"), {
                            method: 'POST',
      ...
      <div className="card max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input id="clinicCode" type="text" value={clinicCode} onChange={function (e) { return setClinicCode(e.target.value); }} className="input-field" placeholder="Enter clinic code" required/>
          </div>
          ...
          <button type="submit" disabled={isLoading || !clinicCode} className="btn-primary w-full flex items-center justify-center gap-2">
